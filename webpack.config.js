    ...
    return {
        ...
        plugins: [
            new webpack.BannerPlugin({
                banner: `TypeScript/JavaScript String Formatter v${packageJson.version} | (c) 2025 Stefan Program | Licensed under the zlib License | Includes JSBI (Apache License 2.0)`
            }),
        ],
